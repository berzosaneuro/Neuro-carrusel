...
export default function UnitCard({ unit }: { unit: UnitStatus }) {
  ...
  const content = (
    <div
      className={`card p-4 flex flex-col gap-1.5 h-full min-h-[112px] ${
    ...
    >
      ...
      <h3 className="text-[14px] font-semibold leading-snug">{unit.title}</h3>
      <p className="text-[12px] text-text-secondary leading-snug">{unit.subtitle}</p>
