# Nicol Gómez · Maquilladora Profesional

Landing page de una sola página para el negocio de maquillaje de Nicol Gómez,
...
nicol-gomez/
  ...
  assets/
    ...
    js/main.js
    img/
      hero-nicol.jpg     Foto de cabecera (hero)
      about-nicol.jpg    Foto de la sección "Hola, soy Nicol"
      favicon.svg
```
...
- **Contacto del pie de página**: ciudad, teléfono e Instagram (`@nicolgomez.makeup`)
  son de ejemplo.
...
(p. ej. `/nicol-gomez/`) y configuro el workflow correspondiente.
